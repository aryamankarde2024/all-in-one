  ...
  try {
    ...
    let basicDetailsStr = `update candidate
        set fname = ${basicDetails[0] ? `'${basicDetails[0]}'` : "NULL"},
            ...
            designation = ${basicDetails[2] ? `'${basicDetails[2]}'` : "NULL"},
            ...
            relationship = ${basicDetails[9] ? `'${basicDetails[9]}'` : "NULL"},
            dob = ${basicDetails[10] ? `'${basicDetails[10]}'` : "NULL"},
            ssc_board = ${basicDetails[11] ? `'${basicDetails[11]}'` : "NULL"},
            ssc_passing_year = ${
            ...
            hsc_board = ${basicDetails[14] ? `'${basicDetails[14]}'` : "NULL"},
            hsc_passing_year = ${
            ...
            department = ${basicDetails[25] ? `'${basicDetails[25]}'` : "NULL"}
        where id = ${id}`;
